...
class Post(models.Model):
    ...
    shirt_size = models.CharField(max_length=1, choices=SHIRT_SIZES, verbose_name='главность поста', blank=True)
    available = models.BooleanField(default=True, null=True, blank=True, verbose_name='доступность читателям')
