...
class VariablesItem(models.Model):
    name = models.TextField(
        max_length=100, verbose_name='вариации', blank=True, null=True)
...
class Needles(models.Model):
    title = models.CharField(
        max_length=255, verbose_name='Название товара', blank=True, null=True)
    ...
    description = models.TextField(
        blank=True, verbose_name='описание товара', null=True)
    price: models.CharField(max_length=255, blank=True,
                            verbose_name='цена', null=True)
    variablesItem = models.TextField(
        blank=True, verbose_name='вариации в формате JSON', null=True)
